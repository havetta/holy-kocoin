...
import {
  ...
  effectScope,
  getCurrentInstance as getCurrentInstance$1,
  h,
  inject as inject$1,
  isRef,
  isVNode,
...
class CircularBuffer {
  ...
  push(val) {
    _classPrivateFieldGet(this, _arr)[_classPrivateFieldGet(this, _pointer)] =
      val;
    _classPrivateFieldSet(
      this,
      _pointer,
      (_classPrivateFieldGet(this, _pointer) + 1) % this.size,
    );
  }
  values() {
    return _classPrivateFieldGet(this, _arr)
      .slice(_classPrivateFieldGet(this, _pointer))
      .concat(
        _classPrivateFieldGet(this, _arr).slice(
          0,
          _classPrivateFieldGet(this, _pointer),
        ),
      );
  }
}
...
function genericComponent() {
  ...
  return (options) =>
    (exposeDefaults ? defineComponent : defineComponent$1)(options);
}
...
function createSimpleFunctional(klass) {
  let tag =
    arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'div';
...
function getPrefixedEventHandlers(attrs, suffix, getData) {
  return Object.keys(attrs)
    ...
    .reduce((acc, key) => {
      acc[key.slice(0, -suffix.length)] = (event) =>
...
function genCssVariables(theme) {
  ...
  for (const [key, value] of Object.entries(theme.colors)) {
    ...
    if (!key.startsWith('on-')) {
      variables.push(
        `--v-theme-${key}-overlay-multiplier: ${getLuma(value) > 0.18 ? lightOverlay : darkOverlay}`,
      );
    }
  }
...
const VFabTransition = createCssTransition(
  'fab-transition',
  'center center',
  'out-in',
);
...
const VScrollXReverseTransition = createCssTransition(
  'scroll-x-reverse-transition',
);
const VScrollYTransition = createCssTransition('scroll-y-transition');
const VScrollYReverseTransition = createCssTransition(
  'scroll-y-reverse-transition',
);
const VSlideXTransition = createCssTransition('slide-x-transition');
const VSlideXReverseTransition = createCssTransition(
  'slide-x-reverse-transition',
);
const VSlideYTransition = createCssTransition('slide-y-transition');
const VSlideYReverseTransition = createCssTransition(
...
const VExpandXTransition = createJavascriptTransition(
  'expand-x-transition',
          ...
          mergeProps(
            {
              ...
              style: [
                {
                  width: convertToUnit(
                    props.width === 'auto' ? naturalWidth.value : props.width,
                  ),
                },
...
function useScroll(props) {
  ...
  const scrollRatio = computed(() => {
    return clamp(
      (scrollThreshold.value - currentScroll.value) / scrollThreshold.value ||
        0,
    );
  });
  const onScroll = () => {
  ...
  setup(props, _ref) {
    ...
    return () => {
      ...
      return createVNode(props.tag, null, {
        default: () => [
          props.icon ? createVNode(Icon, null, null) : slots.default?.(),
        ],
      });
    };
  },
...
const VProgressLinear = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const normalizedBuffer = computed(
      () => (parseFloat(props.bufferValue) / max.value) * 100,
    );
    const normalizedValue = computed(
      () => (parseFloat(progress.value) / max.value) * 100,
    );
              ...
              createVNode(
                'div',
                {
                  ...
                  style: {
                    ...
                    '--v-progress-linear-stream-to': convertToUnit(
              ...
              'div',
              {
                ...
                style: [
                  backgroundColorStyles.value,
                  {
                    opacity: opacity.value,
                    width: convertToUnit(
                      !props.stream ? 100 : normalizedBuffer.value,
                      '%',
                    ),
                  },
                ],
    ...
    isActive:
      ...
      computed(() => {
        ...
        return (
          ...
          deepEqual(link.route.value.query, route.value.query)
        );
      }),
...
const VSelectionControlGroupSymbol = Symbol.for(
      ...
      if (isMultiple.value) {
        newVal = val
          ...
          : wrapInArray(modelValue.value).filter(
              (item) => !props.valueComparator(item, trueValue.value),
            );
      }
      if (group) {
...
function calculateCenteredOffset(_ref2) {
  let { selectedElement, containerSize, contentSize, isRtl, isHorizontal } =
    _ref2;
  const clientSize = isHorizontal
    ? selectedElement.clientWidth
    : selectedElement.clientHeight;
  ...
  setup(props, _ref) {
    ...
    function focus(location) {
      ...
      if (!location) {
        ...
        const el =
          contentRef.value.querySelector(':focus')?.previousElementSibling;
        if (el) el.focus();
        else focus('last');
      } else if (location === 'first') {
...
const useNestedItem = (id, isGroup) => {
  ...
  const computedId = computed(() =>
    id.value !== undefined ? id.value : uidSymbol,
  );
  const item = {
    ...parent,
    id: computedId,
    ...
    isSelected: computed(
      () => parent.root.selected.value.get(toRaw(computedId.value)) === 'on',
    ),
          ...
          default: () => [
            slots.activator &&
              createVNode(
                ...
                {
                  default: () => [
                    createVNode(VListGroupActivator, null, {
                      default: () => [
                        slots.activator({
...
function transformItem$3(props, item) {
  ...
  return {
    ...
    children: Array.isArray(children)
      ? transformItems$3(props, children)
      : undefined,
    raw: item,
  };
}
...
function transformItem$2(props, item) {
  ...
  return {
    ...
    children:
      type === 'item' && children
        ? transformItems$2(props, children)
        : undefined,
    raw: item,
  };
}
...
function connectedLocationStrategy(data, props, contentStyles) {
  ...
  function updateLocation() {
    ...
    function checkOverflow(_placement) {
      ...
      let { x, y } = getOffset$2(targetPoint, contentPoint);
...
const VOverlay = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const { hasContent, onAfterLeave: _onAfterLeave } = useLazy(
      props,
      isActive,
    );
...
function forwardRefs(target) {
  for (
    var _len = arguments.length,
      refs = new Array(_len > 1 ? _len - 1 : 0),
      _key = 1;
    _key < _len;
    _key++
  ) {
...
const VSelect = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const displayItems = computed(() => {
      if (props.hideSelected) {
        return items.value.filter(
          (item) => !model.value.some((s) => s === item),
        );
      }
      return items.value;
    });
    ...
    const listRef = ref();
    const { onListScroll, onListKeydown } = useScrolling(
      listRef,
      vTextFieldRef,
    );
    function onClear(e) {
            ...
            items.value.map((_ref2, index, array) => {
              ...
              return createVNode(Fragment, null, [
                ...
                index < array.length - 1 &&
                  createVNode(VBreadcrumbsDivider, null, {
        ...
        },
        {
          default: () => [
            withDirectives(
              ...
              [[vShow, groupItem.isSelected.value]],
            ),
          ],
        },
      ),
  ...
  setup(props, _ref) {
    ...
    useRender(() => {
      ...
      return createVNode(
        ...
        {
          default: () => [
            createVNode(VImg, mergeProps(attrs, imgProps), slots),
          ],
        },
      );
    });
...
const makeVColorPickerEditProps = propsFactory(
  {
    ...
    modes: {
      ...
      validator: (v) =>
        Array.isArray(v) && v.every((m) => Object.keys(modes).includes(m)),
    },
    ...makeComponentProps(),
  },
  'VColorPickerEdit',
      ...
      return mode.inputs?.map((_ref3) => {
        ...
        return {
          ...
          onChange: (e) => {
            ...
            emit(
              'update:color',
              mode.from(getColor(color ?? mode.to(nullColor), target.value)),
            );
          },
        };
      });
      ...
      createVNode(
        ...
        [
          inputs.value?.map((props) =>
            createVNode(VColorPickerInput, props, null),
          ),
          enabledModes.value.length > 1 &&
            createVNode(
              VBtn,
              {
                ...
                variant: 'plain',
                onClick: () => {
                  const mi = enabledModes.value.findIndex(
                    (m) => m.name === props.mode,
                  );
                  emit(
                    'update:mode',
                    enabledModes.value[(mi + 1) % enabledModes.value.length]
                      .name,
                  );
                },
              },
...
const useSlider = (_ref) => {
  ...
  function parseMouseMove(e) {
    ...
    let clickPos =
      Math.min(
        Math.max(
          (clickOffset - trackStart - startOffset.value) / trackLength,
          0,
        ),
        1,
      ) || 0;
...
const VSliderTrack = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const startDir = computed(
      () =>
        `inset-${vertical.value ? 'block' : 'inline'}-${indexFromEnd.value ? 'end' : 'start'}`,
    );
        ...
        mergeProps(
          {
            class: [
              ...
              {
                'v-slider--has-labels':
                  !!slots['tick-label'] || hasLabels.value,
          ...
          default: (_ref4) => {
            ...
            return createVNode(
              'div',
              {
                ...
                onTouchstartPassive: !readonly.value
                  ? onSliderTouchstart
                  : undefined,
              },
              [
...
function groupItems(items, groupBy) {
  let depth =
    arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
  let prefix =
    arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 'root';
...
function useGroupedItems(items, groupBy, opened) {
  const flatItems = computed(() => {
    ...
    const groupedItems = groupItems(
      items.value,
      groupBy.value.map((item) => item.key),
    );
...
function getDiff(date, comparing, unit) {
  ...
  if (unit === 'month') {
    return (
      d.getMonth() - c.getMonth() + (d.getFullYear() - c.getFullYear()) * 12
    );
  }
  ...
  return new Promise((resolve) =>
    requestAnimationFrame(function step(currentTime) {
      ...
      const location = Math.floor(
        startLocation +
          (targetLocation - startLocation) * ease(Math.max(progress, 1)),
      );
...
function transformItem$1(props, item) {
  const value = props.returnObject
    ? item
    : getPropertyFromItem(item, props.itemValue);
...
const VDataIterator = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const { isSelected, select, selectAll, toggleSelect } = provideSelection(
      props,
      {
        allItems: items,
      ...
      return createVNode(
        ...
        [
          ...
          createVNode(
            ...
            [
              createVNode('span', null, [t(props.itemsPerPageText)]),
              createVNode(
                VSelect,
                {
          ...
          createVNode(
            ...
            [
              createVNode('div', null, [
                t(
                  props.pageText,
                  !itemsLength.value ? 0 : startIndex.value + 1,
                  stopIndex.value,
                  itemsLength.value,
                ),
              ]),
        ...
        ),
        {
          default: () => {
            ...
            if (column.key === 'data-table-select') {
              return (
                slots['header.data-table-select']?.(columnSlotProps) ??
                (showSelectAll &&
                  createVNode(
                    VCheckboxBtn,
                    {
                ...
                ),
                {
                  default: () => {
                    ...
                    if (column.key === 'data-table-expand') {
                      return (
                        slots['item.data-table-expand']?.(slotProps) ??
                        createVNode(
                          VBtn,
                          {
          ...
          return createVNode(
            ...
            [
              slots.item
                ...
                : createVNode(VDataTableRow, itemSlotProps.props, slots),
          ...
          default: () => [
            ...
            slots.default
              ? createVNode(
                  ...
                  [createVNode('table', null, [slots.default()])],
                )
              : slots.wrapper?.(),
            slots.bottom?.(),
          ],
        ...
        ),
        {
              ...
              : createVNode(Fragment, null, [
                  ...
                  createVNode('tbody', null, [
                    ...
                    slots.body
                      ...
                      : createVNode(
                          VDataTableRows,
                          mergeProps(attrs, dataTableRowsProps, {
          ...
          bottom: () =>
            slots.bottom
              ...
              : createVNode(Fragment, null, [
                  createVNode(VDivider, null, null),
                  createVNode(VDataTableFooter, dataTableFooterProps, {
              ...
              [
                createVNode('table', null, [
                  ...
                  createVNode('thead', null, [
                    createVNode(
                      VDataTableHeaders,
                      mergeProps(dataTableHeadersProps, {
                            ...
                            },
                            {
                              default: (_ref2) => {
                                ...
                                return (
                                  ...
                                  createVNode(
                                    VDataTableRow,
                                    mergeProps(itemSlotProps.props, {
                                      ref: itemRef,
                                      key: itemSlotProps.internalItem.index,
...
function useCalendar(props) {
  ...
  const month = useProxiedModel(
    ...
    (v) => {
      const value =
        v != null ? Number(v) : adapter.getMonth(displayValue.value);
      const date = adapter.setYear(
        adapter.startOfMonth(adapter.date()),
  ...
  function genDays(days, today) {
    return days
      ...
      .map((date, index) => {
        ...
        const isStart = adapter.isSameDay(
          date,
          adapter.startOfMonth(month.value),
        );
        ...
        return {
          ...
          isStart,
          isSelected: model.value.some((value) =>
            adapter.isSameDay(date, value),
          ),
          isEnd,
          isSame,
  ...
  function isDisabled(value) {
    ...
    if (Array.isArray(props.allowedDates) && props.allowedDates.length > 0) {
      return !props.allowedDates.some((d) =>
        adapter.isSameDay(adapter.date(d), date),
      );
    }
...
const VDatePickerMonth = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const atMax = computed(() => {
      const max = ['number', 'string'].includes(typeof props.multiple)
        ? Number(props.multiple)
        : Infinity;
    ...
    function onMultipleClick(value) {
      const index = model.value.findIndex((selection) =>
        adapter.isSameDay(selection, value),
      );
      if (index === -1) {
                    ...
                    (props.showAdjacentMonths || !item.isAdjacent) &&
                      createVNode(
                        ...
                        },
                        {
                          default: () => [
                            slots.day?.(slotProps) ??
                              createVNode(VBtn, slotProps.props, null),
                          ],
                        },
                      ),
                  ],
...
const VDatePicker = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const month = ref(
      Number(
        props.month ?? adapter.getMonth(adapter.startOfMonth(internal.value)),
      ),
    );
    const year = ref(
      Number(
        props.year ??
          adapter.getYear(
            adapter.startOfYear(adapter.setMonth(internal.value, month.value)),
          ),
      ),
    );
    ...
    const headerTransition = computed(
      () =>
        `date-picker-header${isReversing.value ? '-reverse' : ''}-transition`,
    );
    ...
    useRender(() => {
      ...
      const datePickerMonthsProps = omit(VDatePickerMonths.filterProps(props), [
        'modelValue',
      ]);
      const datePickerYearsProps = omit(VDatePickerYears.filterProps(props), [
        'modelValue',
      ]);
      const headerProps = {
        header: header.value,
        ...
        }),
        {
            ...
            slots.header
              ...
              : createVNode(
                  ...
                  mergeProps(
                    ...
                    {
                      onClick:
                        viewMode.value !== 'month' ? onClickDate : undefined,
                    },
                  ),
                  {
                    ...slots,
          ...
          default: () =>
            createVNode(Fragment, null, [
              createVNode(
                VDatePickerControls,
                mergeProps(datePickerControlsProps, {
        ...
        },
        {
          default: () => [
            withDirectives(
              ...
              [[vShow, expansionPanel.isSelected.value]],
            ),
          ],
        },
      ),
                ...
                [
                  slots.actions
                    ...
                    : createVNode(
                        VIcon,
                        {
                          icon: expansionPanel.isSelected.value
                            ? props.collapseIcon
                            : props.expandIcon,
                        },
                        null,
...
const VFileInput = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const totalBytes = computed(() =>
      (model.value ?? []).reduce((bytes, _ref2) => {
        let { size = 0 } = _ref2;
        return bytes + size;
      }, 0),
    );
...
const VHover = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const { runOpenDelay, runCloseDelay } = useDelay(
      props,
      (value) => !props.disabled && (isHovering.value = value),
    );
    return () =>
      slots.default?.({
    ...
    function renderSide(side, status) {
      ...
      if (status === 'empty')
        return (
          ...
          createVNode('div', null, [t(props.emptyText)])
        );
      if (props.mode === 'manual') {
        if (status === 'loading') {
          return (
...
const VItem = genericComponent()({
  ...
  setup(props, _ref) {
    let { slots } = _ref;
    const { isSelected, select, toggle, selectedClass, value, disabled } =
              ...
              fields.value.map((_, i) =>
                createVNode(Fragment, null, [
                  ...
                  createVNode(
                    ...
                    {
                      focused:
                        (isFocused.value && props.focusAll) ||
                        focusIndex.value === i,
                      key: i,
                    },
                    {
  ...
  setup(props, _ref) {
    ...
    watch(isIntersecting, (val) => {
      if (val) {
        ...
        scrollParent =
          scrollParent === document.scrollingElement ? document : scrollParent;
    ...
    function onScroll() {
      ...
      frame = requestAnimationFrame(() => {
        ...
        const top =
          intersectionRef.value.getBoundingClientRect().top + scrollPos;
        const height = contentRect.value.height;
        const center = top + (height - scrollHeight) / 2;
        const translate = floor((scrollPos - center) * scale.value);
        const sizeScale = Math.max(
          1,
          (scale.value * (scrollHeight - height) + height) / height,
        );
        el.style.setProperty(
          'transform',
          `translateY(${translate}px) scale(${sizeScale})`,
        );
      });
    }
    useRender(() =>
...
const VRangeSlider = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    function getActiveThumb(e) {
      ...
      const startOffset = getOffset$1(
        e,
        startThumbRef.value.$el,
        props.direction,
      );
      const stopOffset = getOffset$1(
        e,
        stopThumbRef.value.$el,
        props.direction,
      );
...
const VRating = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    function VRatingItem(_ref2) {
      ...
      const { onMouseenter, onMouseleave, onClick } =
                ...
                [
                  createVNode(
                    VProgressLinear,
                    {
                      ref: timerRef,
                      color:
                        typeof props.timer === 'string' ? props.timer : 'info',
                      max: props.timeout,
...
const VStepperItem = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const isValid = computed(() =>
      props.rules.every((handler) => handler() === true),
    );
    const canEdit = computed(() => !props.disabled && props.editable);
    const hasError = computed(() => props.error || !isValid.value);
    const hasCompleted = computed(
      () => props.complete || (props.rules.length > 0 && isValid.value),
    );
    const icon = computed(() => {
    ...
    useRender(() => {
      ...
      return withDirectives(
        ...
        [[resolveDirective('ripple'), props.ripple && props.editable, null]],
      );
    });
    return {};
  },
  ...
  setup(props, _ref) {
    ...
    const model = computed({
      get() {
        ...
        return group.items.value.find((item) =>
          group.selected.value.includes(item.id),
        )?.value;
      },
      set(val) {
              ...
              createVNode(
                ...
                },
                {
                  default: () => [
                    items.value.map((item, index) =>
                      createVNode(Fragment, null, [
                        !!index && createVNode(VDivider, null, null),
                        createVNode(VStepperItem, item, {
                          default:
                            slots[`header-item.${item.value}`] ?? slots.header,
                          icon: slots.icon,
                          title: slots.title,
                          subtitle: slots.subtitle,
                        }),
...
const VTab = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    function updateSlider(_ref2) {
      let { value } = _ref2;
      if (value) {
        const prevEl = rootEl.value?.$el.parentElement?.querySelector(
...
const VTimelineDivider = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    const { backgroundColorStyles, backgroundColorClasses } =
          ...
          style: [
            {
              ...
              '--v-timeline-line-inset': props.lineInset
                ? `calc(var(--v-timeline-dot-size) / 2 + ${convertToUnit(props.lineInset)})`
                : convertToUnit(0),
            },
            props.style,
          ],
