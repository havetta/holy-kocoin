 ...
 */
import { Color as t } from './@kurkle/color@0.3.2/+esm.js';
function e() {}
const i = (() => {
  let t = 0;
  return () => t++;
...
function z(t) {
  ...
  t = I(t, e, t / 1e3) ? e : t;
  const i = Math.pow(10, Math.floor(E(t))),
    s = t / i;
...
function H(t, e) {
  ...
  return o < -0.5 * S && (o += P), { angle: o, distance: n };
}
function j(t, e) {
...
const G = (t, e, i, s) =>
  ...
  J = (t, e, i) => K(t, i, (s) => t[s][e] >= i);
const Q = ['push', 'pop', 'shift', 'splice', 'unshift'];
function Z(t, e) {
  const i = t._chartjs;
  if (!i) return;
  const s = i.listeners,
...
function ot(t, e, i) {
  ...
  if (t._sorted) {
    ...
    d &&
      (n = X(
        Math.min(G(r, l, h).lo, i ? s : G(e, l, a.getPixelForValue(h)).lo),
        0,
        s - 1,
      )),
      (o = u
        ? X(
            Math.max(
              G(r, a.axis, c, !0).hi + 1,
              i ? 0 : G(e, l, a.getPixelForValue(c), !0).hi + 1,
            ),
            n,
            s,
          ) - n
...
const rt = (t) => 0 === t || 1 === t,
  lt = (t, e, i) => -Math.pow(2, 10 * (t -= 1)) * Math.sin(((t - e) * P) / i),
  ht = (t, e, i) => Math.pow(2, -10 * t) * Math.sin(((t - e) * P) / i) + 1,
  ct = {
    linear: (t) => t,
    easeInQuad: (t) => t * t,
    easeOutQuad: (t) => -t * (t - 2),
    ...
    easeInElastic: (t) => (rt(t) ? t : lt(t, 0.075, 0.3)),
    easeOutElastic: (t) => (rt(t) ? t : ht(t, 0.075, 0.3)),
    easeInOutElastic(t) {
      const e = 0.1125;
      return rt(t)
        ? t
...
function ut(e) {
  return dt(e) ? e : new t(e);
}
function gt(e) {
  return dt(e) ? e : new t(e).saturate(0.5).darken(0.1).hexString();
}
const ft = ['x', 'y', 'borderWidth', 'radius', 'tension'],
  pt = ['color', 'borderColor', 'backgroundColor'];
const mt = new Map();
function xt(t, e, i) {
  return (function (t, e) {
    e = e || {};
    ...
    let s = mt.get(i);
    return s || ((s = new Intl.NumberFormat(t, e)), mt.set(i, s)), s;
  })(e, i).format(t);
}
const bt = {
  values: (t) => (n(t) ? t : `${t}`),
  numeric(t, e, i) {
    ...
    const a = E(Math.abs(o)),
      r = isNaN(a) ? 1 : Math.max(Math.min(-1 * Math.floor(a), 20), 0),
      l = { notation: n, minimumFractionDigits: r, maximumFractionDigits: r };
    return Object.assign(l, this.options.ticks.format), xt(t, s, l);
  },
  logarithmic(t, e, i) {
    if (0 === t) return '0';
    const s = i[e].significand || t / Math.pow(10, Math.floor(E(t)));
    return [1, 2, 3, 5, 10, 15].includes(s) || e > 0.8 * i.length
      ? bt.numeric.call(this, t, e, i)
      : '';
  },
};
var _t = { formatters: bt };
...
function wt(t, e, i) {
  return 'string' == typeof e ? m(Mt(t, e), i) : m(Mt(t, ''), e);
}
class kt {
  constructor(t, e) {
  ...
  [
    function (t) {
      t.set('animation', {
        ...
        t.set('animations', {
          colors: { type: 'color', properties: pt },
          numbers: { type: 'number', properties: ft },
        }),
    ...
    if (((u = i[h]), null == u || n(u))) {
      if (n(u))
        for (c = 0, d = u.length; c < d; c++)
          (g = u[c]), null == g || n(g) || (r = Pt(t, o, a, r, g));
    } else r = Pt(t, o, a, r, u);
  t.restore();
  const f = a.length / 2;
  if (f > i.length) {
    for (h = 0; h < f; h++) delete o[a[h]];
    a.splice(0, f);
  }
  return r;
}
...
function Tt(t, e, i, s, n) {
  ...
  if (!(isNaN(p) || p <= 0)) {
    switch ((t.beginPath(), g)) {
      default:
        n ? t.ellipse(i, s, n / 2, p, 0, 0, P) : t.arc(i, s, p, 0, P),
          t.closePath();
        break;
      case 'triangle':
        (c = n ? n / 2 : p),
      ...
      case 'rectRounded':
        (h = 0.516 * p),
          (l = p - h),
          (a = Math.cos(m + T) * l),
          (d = Math.cos(m + T) * (n ? n / 2 - h : l)),
          (r = Math.sin(m + T) * l),
          (u = Math.sin(m + T) * (n ? n / 2 - h : l)),
          t.arc(i - d, s - r, h, m - S, m - A),
          t.arc(i + u, s - a, h, m - A, m),
          t.arc(i + d, s + r, h, m, m + A),
          t.arc(i - u, s + a, h, m + A, m + S),
          t.closePath();
        break;
      case 'rect':
        if (!f) {
...
function Wt(t, e) {
  ...
  t.arc(i + a.topLeft, s + a.topLeft, a.topLeft, 1.5 * S, S, !0),
    t.lineTo(i, s + o - a.bottomLeft),
    t.arc(i + a.bottomLeft, s + o - a.bottomLeft, a.bottomLeft, S, A, !0),
    ...
    t.arc(i + n - a.topRight, s + a.topRight, a.topRight, 0, -A, !0),
    t.lineTo(i + a.topLeft, s);
}
const Nt = /^(normal|(\d+(?:\.\d+)?)(px|em|%)?)$/,
  Ht = /^(normal|italic|initial|inherit|unset|(oblique( -?[0-9]?[0-9]deg)?))$/;
function jt(t, e) {
  const i = `${t}`.match(Nt);
...
function Ut(t, e) {
  ...
  for (const t of n) i[t] = $t(a(t));
  return i;
}
function Yt(t) {
  return Ut(t, { top: 'y', right: 'x', bottom: 'y', left: 'x' });
}
function Xt(t) {
  return Ut(t, ['topLeft', 'topRight', 'bottomLeft', 'bottomRight']);
}
function qt(t) {
  const e = Yt(t);
...
function Kt(t, e) {
  ...
  const o = {
    ...
    lineHeight: jt(l(t.lineHeight, e.lineHeight), i),
    size: i,
    style: n,
    ...
    get: (i, s) =>
      se(i, s, () =>
        (function (t, e, i, s) {
          let n;
          for (const o of e)
            if (((n = he(ee(o, t), i)), void 0 !== n))
              return ie(t, n) ? re(i, s, t, n) : n;
        })(s, e, t, i),
      ),
        ...
        (function (t, e, i) {
          ...
          w(h) &&
            ...
            (h = (function (t, e, i, s) {
              ...
              r.add(t);
              let l = e(o, a || s);
              r.delete(t), ie(t, l) && (l = re(n._scopes, n, t, l));
              return l;
            })(e, h, t, i));
          n(h) &&
            h.length &&
            (h = (function (t, e, i, s) {
              ...
              if (o(e[0])) {
                ...
                for (const o of i) {
                  const i = re(s, n, t, o);
                  e.push(Zt(i, a, r && r[t], l));
                }
              }
              return e;
            })(e, h, t, l.isIndexable));
          ie(e, h) && (h = Zt(h, a, r && r[e], l));
          return h;
        })(t, e, i),
      ),
...
function re(t, e, i, s) {
  const a = e._rootScopes,
    r = ne(e._fallback, i, s),
    l = [...t, ...a],
    h = new Set();
  h.add(s);
  let c = le(h, l, i, r || i, s);
  return (
    null !== c &&
    (void 0 === r || r === i || ((c = le(h, l, r, c, s)), null !== c)) &&
    Qt(Array.from(h), [''], a, r, () =>
      (function (t, e, i) {
  ...
  !(function (t, e, i) {
    ...
    (function (t, e, i = 'x') {
      ...
      let o,
        ...
        l = ge(t, 0);
      for (let h = 0; h < n; ++h) {
        if (((a = r), (r = l), (l = ge(t, h + 1)), !r)) continue;
        const n = r[i],
          c = r[s];
        a &&
          ((o = (n - a[i]) / 3),
...
function be(t, e, i, s, n) {
  ...
  if (
    ...
    for (o = 0, a = t.length; o < a; ++o)
      (r = t[o]),
        (l = pe(i, r, t[Math.min(o + 1, a - (s ? 0 : 1)) % a], e.tension)),
        (r.cp1x = l.previous.x),
        (r.cp1y = l.previous.y),
        (r.cp2x = l.next.x),
        (r.cp2y = l.next.y),
...
const Se = (t, e, i) => (t > 0 || e > 0) && (!i || !i.shadowRoot);
function Pe(t, e) {
  ...
  return (
    o && ((g -= a.width + r.width), (f -= a.height + r.height)),
    {
      x: Math.round((((l - d) / g) * i.width) / s),
      y: Math.round((((h - u) / f) * i.height) / s),
    }
  );
}
const De = (t) => Math.round(10 * t) / 10;
function Ce(t, e, i, s) {
  const n = Me(t),
    o = ke(n, 'margin'),
    a = ve(n.maxWidth, t, 'clientWidth') || C,
    r = ve(n.maxHeight, t, 'clientHeight') || C,
    l = (function (t, e, i) {
      let s, n;
      if (void 0 === e || void 0 === i) {
        ...
        if (o) {
          ...
          (e = t.width - l.width - r.width),
            ...
            (s = ve(a.maxWidth, o, 'clientWidth')),
            (n = ve(a.maxHeight, o, 'clientHeight'));
  ...
  if ('content-box' === n.boxSizing) {
    const t = ke(n, 'border', 'width'),
      e = ke(n, 'padding');
    (h -= e.width + t.width), (c -= e.height + t.height);
  }
  (h = Math.max(0, h - o.width)),
    (c = Math.max(0, s ? h / s : c - o.height)),
    (h = De(Math.min(h, a, l.maxWidth))),
    (c = De(Math.min(c, r, l.maxHeight))),
    h && !c && (c = De(h / 2));
  return (
    (void 0 !== e || void 0 !== i) &&
      s &&
      l.height &&
      c > l.height &&
      ((c = l.height), (h = De(Math.floor(c * s)))),
    { width: h, height: c }
  );
}
function Oe(t, e, i) {
...
function Ve(t) {
  return 'angle' === t
    ? { between: Y, compare: $, normalize: U }
    : { between: q, compare: (t, e) => t - e, normalize: (t) => t };
}
function Be({ start: t, end: e, count: i, loop: s, style: n }) {
  return {
    start: t % i,
    end: e % i,
    loop: s && (e - t + 1) % i == 0,
...
function We(t, e, i) {
  ...
  const { property: s, start: n, end: o } = i,
    a = e.length,
    { compare: r, between: l, normalize: h } = Ve(s),
    {
      start: c,
      end: d,
      loop: u,
    ...
    (m = e[t % a]),
      m.skip ||
        ...
        p !== x &&
          ...
          null !== _ &&
            v() &&
            (f.push(Be({ start: _, end: t, loop: u, count: a, style: g })),
            (_ = null)),
          (i = t),
          (x = p)));
  return (
    null !== _ && f.push(Be({ start: _, end: d, loop: u, count: a, style: g })),
    f
  );
}
function Ne(t, e) {
...
function $e(t, e) {
  ...
  const i = [],
    s = function (t, e) {
      return dt(e) ? (i.includes(e) || i.push(e), i.indexOf(e)) : e;
    };
...
class Ke {
  constructor(t, e, i, s) {
    const n = e[i];
    s = Gt([t.to, s, n, t.from]);
    const o = Gt([t.from, n, s]);
    (this._active = !0),
      (this._fn = t.fn || qe[t.type || typeof o]),
  ...
  update(t, e, i) {
    if (this._active) {
      ...
      (this._start = i),
        ...
        (this._total += n),
        (this._loop = !!t.loop),
        (this._to = Gt([t.to, e, s, t.from])),
        (this._from = Gt([t.from, s, e]));
    }
  }
  cancel() {
    this._active &&
...
class Ge {
  ...
  update(t, e) {
    ...
    return i.length ? (Ye.add(this._chart, i), !0) : void 0;
  }
}
function Je(t, e) {
  const i = (t && t.options) || {},
...
function Ze(t, e, i, s = {}) {
  ...
  if (null !== e) {
    for (r = 0, l = n.length; r < l; ++r) {
      ...
      (c = t.values[h]), a(c) && (o || 0 === e || R(e) === R(c)) && (e += c);
    }
    return e;
  }
}
...
function si(t, e) {
  ...
  for (let t = 0; t < d; ++t) {
    const i = e[t],
      { [l]: o, [h]: d } = i;
    (u = (i._stacks || (i._stacks = {}))[h] = ei(n, c, o)),
      (u[r] = d),
      (u._top = ii(u, a, !0, s.type)),
      (u._bottom = ii(u, a, !1, s.type));
...
class li {
  ...
  linkScales() {
    const t = this.chart,
      ...
      n = (e.xAxisID = l(i.xAxisID, ni(t, 'x'))),
      o = (e.yAxisID = l(i.yAxisID, ni(t, 'y'))),
      a = (e.rAxisID = l(i.rAxisID, ni(t, 'r'))),
      r = e.indexAxis,
  ...
  _destroy() {
    const t = this._cachedMeta;
    this._data && Z(this._data, this), t._stacked && oi(t);
  }
  _dataCheck() {
  ...
  buildOrUpdateElements(t) {
    ...
    this._dataCheck();
    const n = e._stacked;
    (e._stacked = ti(e.vScale, e)),
      e.stack !== i.stack && ((s = !0), oi(e), (e.stack = i.stack)),
      this._resyncElements(t),
      (s || n !== e._stacked) && si(this, e._parsed);
  }
  configure() {
  ...
  parse(t, e) {
    ...
    if (!1 === this._parsing) (i._parsed = s), (i._sorted = !0), (d = s);
      ...
      const a = () => null === c[l] || (g && c[l] < g[l]);
      for (h = 0; h < e; ++h)
        (i._parsed[h + t] = c = d[h]), u && (a() && (u = !1), (g = c));
      i._sorted = u;
    }
    r && si(this, d);
  }
  parsePrimitiveData(t, e, i, s) {
    ...
    for (d = 0, u = s; d < u; ++d)
      (g = d + i),
        (c[d] = { [a]: h || n.parse(l[g], g), [r]: o.parse(e[g], g) });
    return c;
  }
  ...
  applyStack(t, e, i) {
    const s = this.chart,
      ...
      o = e[t.axis];
    return Ze(
      { keys: Qe(s, !0), values: e._stacks[t.axis]._visualValues },
      o,
      n.index,
      { mode: i },
    );
  ...
  updateRangeFromParsed(t, e, i, s) {
    ...
    s && a && ((s.values = a), (o = Ze(s, n, this._cachedMeta.index))),
  ...
  getMinMax(t, e) {
    const i = this._cachedMeta,
      ...
      l = ((t, e, i) =>
        t && !e.hidden && e._stacked && { keys: Qe(i, !0), values: null })(
        e,
        i,
        this.chart,
      ),
    ...
    function f() {
      g = s[u];
      const e = g[r.axis];
      return !a(g[t.axis]) || c > e || d < e;
    }
    for (
      u = 0;
      u < o && (f() || (this.updateRangeFromParsed(h, t, g, l), !n));
      ++u
    );
    if (n)
      for (u = o - 1; u >= 0; --u)
  ...
  _resolveElementOptions(t, e = 'default', i) {
    ...
    const l = this.chart.config,
      ...
      u = Object.keys(St.elements[t]),
      g = l.resolveNamedOptions(d, u, () => this.getContext(i, s, e), c);
    return g.$shared && ((g.$shared = r), (n[o] = Object.freeze(ri(g, r)))), g;
  }
  _resolveAnimations(t, e, i) {
    ...
    const l = new Ge(s, r && r.animations);
...
function mi(t, { inflateAmount: e }, i) {
...
class xi extends li {
  ...
  parseObjectData(t, e, i, s) {
    ...
    for (d = i, u = i + s; d < u; ++d)
      (f = e[d]),
        (g = {}),
        (g[n.axis] = n.parse(y(f, l), d)),
        c.push(ci(y(f, h), g, o, d));
    return c;
  }
  updateRangeFromParsed(t, e, i, s) {
  ...
  getLabelAndValue(t) {
    const e = this._cachedMeta,
      ...
      n = this.getParsed(t),
      o = n._custom,
      a = ui(o) ? `[${o.start}, ${o.end}]` : `${s.getLabelForValue(n[s.axis])}`;
  ...
  updateElements(t, e, i, n) {
    ...
    for (let g = e; g < e + i; g++) {
      const e = this.getParsed(g),
        ...
        f = this._calculateBarIndexPixels(g, c),
        p = (e._stacks || {})[r.axis],
        m = {
          horizontal: h,
          base: i.base,
          enableBorderRadius:
            !p || ui(e._custom) || a === p._top || a === p._bottom,
          x: h ? i.head : f.center,
          y: h ? f.center : i.head,
      ...
      u &&
        (m.options =
          d || this.resolveDataElementOptions(g, t[g].active ? 'active' : n));
      const x = m.options || t[g].options;
      gi(m, x, p, a), mi(m, x, c.ratio), this.updateElement(t[g], g, m, n);
    }
  }
  _getStacks(t, e) {
  ...
  _calculateBarValuePixels(t) {
    ...
    let d,
      ...
      g = l[e.axis],
      f = 0,
      p = i ? this.applyStack(e, l, i) : g;
    p !== g && ((f = p - g), (p = g)),
      c &&
        ((g = h.barStart),
        (p = h.barEnd - h.barStart),
        0 !== g && R(g) !== R(h.barEnd) && (f = 0),
        (f += g));
    const m = s(o) || c ? f : o;
    let x = e.getPixelForValue(m);
    if (
      ((d = this.chart.getDataVisibility(t) ? e.getPixelForValue(f + p) : x),
      (u = d - x),
      Math.abs(u) < a)
    ) {
      (u =
    ...
    if (x === e.getPixelForValue(r)) {
      const t = (R(u) * e.getLineWidthForValue(r)) / 2;
      (x += t), (u -= t);
    }
  ...
  updateElements(t, e, i, s) {
    ...
    for (let d = e; d < e + i; d++) {
      const e = t[d],
        ...
        u = {},
        g = (u[h] = n ? o.getPixelForDecimal(0.5) : o.getPixelForValue(i[h])),
        f = (u[c] = n ? a.getBasePixel() : a.getPixelForValue(i[c]));
...
class _i extends li {
  ...
  update(t) {
    ...
    const d = this._getRingWeight(this.index),
      { circumference: u, rotation: g } = this._getRotationExtents(),
      {
        ...
        if (e < P) {
          const r = t,
            ...
            u = Math.sin(l),
            g = (t, e, s) =>
              Y(t, r, l, !0) ? 1 : Math.max(e, e * i, s, s * i),
            f = (t, e, s) =>
              Y(t, r, l, !0) ? -1 : Math.min(e, e * i, s, s * i),
            p = g(0, h, d),
            m = g(A, c, u),
            x = f(S, h, d),
            b = f(S + A, c, u);
      ...
      v = h(this.options.radius, y),
      M = (v - Math.max(v * r, 0)) / this._getVisibleDatasetWeightTotal();
    (this.offsetX = m * v),
      (this.offsetY = x * v),
      (s.total = this.calculateTotal()),
      (this.outerRadius = v - M * this._getRingWeightOffset(this.index)),
      (this.innerRadius = Math.max(this.outerRadius - M * d, 0)),
  ...
  _circumference(t, e) {
    ...
    return (e && i.animation.animateRotate) ||
      ...
      s.data[t].hidden
      ? 0
      : this.calculateCircumference((s._parsed[t] * n) / P);
  }
  updateElements(t, e, i, s) {
    const n = 'reset' === s,
      o = this.chart,
  ...
  getLabelAndValue(t) {
    const e = this._cachedMeta,
      i = this.chart,
      s = i.data.labels || [],
      n = xt(e._parsed[t], i.options.locale);
...
class yi extends li {
  ...
  updateElements(t, e, i, n) {
    const o = 'reset' === n,
      ...
      m = F(f) ? f : Number.POSITIVE_INFINITY,
    ...
    for (let i = 0; i < _; ++i) {
      ...
      const v = this.getParsed(i),
        ...
        k = (_[g] =
          o || M
            ? r.getBasePixel()
            : r.getPixelForValue(l ? this.applyStack(r, v, l) : v[g], i));
      (_.skip = isNaN(w) || isNaN(k) || M),
        (_.stop = i > 0 && Math.abs(v[u] - y[u]) > m),
        p && ((_.parsed = v), (_.raw = h.data[i])),
        d &&
          (_.options =
            c || this.resolveDataElementOptions(i, f.active ? 'active' : n)),
        x || this.updateElement(f, i, _, n),
        (y = v);
    }
  }
  getMaxOverflow() {
...
class vi extends li {
  ...
  getLabelAndValue(t) {
    const e = this._cachedMeta,
      i = this.chart,
      s = i.data.labels || [],
      n = xt(e._parsed[t].r, i.options.locale);
    return { label: s[t] || '', value: n };
  }
  parseObjectData(t, e, i, s) {
    return de.bind(this)(t, e, i, s);
  }
  update(t) {
    const e = this._cachedMeta.data;
  ...
  updateElements(t, e, i, s) {
    ...
    for (d = e; d < e + i; d++) {
      const e = t[d];
      let i = u,
        f = u + this._computeAngle(d, s, g),
        p = o.getDataVisibility(d)
          ? r.getDistanceFromCenterForValue(this.getParsed(d).r)
          : 0;
      (u = f), n && (a.animateScale && (p = 0), a.animateRotate && (i = f = c));
      const m = {
        x: l,
        y: h,
        innerRadius: 0,
  ...
  _computeAngle(t, e, i) {
    return this.chart.getDataVisibility(t)
      ? B(this.resolveDataElementOptions(t, e).angle || i)
      : 0;
  }
}
class Mi extends _i {
...
class ki extends li {
  ...
  updateElements(t, e, i, n) {
    const o = 'reset' === n,
      ...
      x = F(p) ? p : Number.POSITIVE_INFINITY,
    ...
    for (let c = e; c < e + i; ++c) {
      const e = t[c],
        ...
        p = b ? e : {},
        y = s(i[f]),
        v = (p[g] = a.getPixelForValue(i[g], c)),
        M = (p[f] =
          o || y
            ? r.getBasePixel()
            : r.getPixelForValue(l ? this.applyStack(r, i, l) : i[f], c));
      (p.skip = isNaN(v) || isNaN(M) || y),
        (p.stop = c > 0 && Math.abs(i[g] - _[g]) > x),
...
function Li(t, e, i, s, n, o) {
  ...
  return (
    Ai(t, i, e, function (i, h, c) {
      ...
      const g = r(e, u);
      g < l
        ? ((a = [{ element: i, datasetIndex: h, index: c }]), (l = g))
        : g === l && a.push({ element: i, datasetIndex: h, index: c });
    }),
    a
  );
}
function Ei(t, e, i, s, n, o) {
          ...
          return (
            Ai(t, i, e, function (t, i, o) {
              const { startAngle: a, endAngle: r } = t.getProps(
                ...
                { angle: l } = H(t, { x: e.x, y: e.y });
              Y(l, a, r) && n.push({ element: t, datasetIndex: i, index: o });
            }),
            n
          );
        })(t, e, i, n)
  ...
  modes: {
    index(t, e, i, s) {
      const n = Pe(e, t),
        ...
        r = i.intersect ? Ti(t, n, o, s, a) : Ei(t, n, o, !1, s, a),
        l = [];
      return r.length
    ...
    dataset(t, e, i, s) {
      const n = Pe(e, t),
        o = i.axis || 'xy',
        a = i.includeInvisible || !1;
      let r = i.intersect ? Ti(t, n, o, s, a) : Ei(t, n, o, !1, s, a);
      if (r.length > 0) {
    ...
    point: (t, e, i, s) =>
      Ti(t, Pe(e, t), i.axis || 'xy', s, i.includeInvisible || !1),
    nearest(t, e, i, s) {
      const n = Pe(e, t),
        o = i.axis || 'xy',
        a = i.includeInvisible || !1;
      return Ei(t, n, o, i.intersect, s, a);
    },
    x: (t, e, i, s) => Ri(t, Pe(e, t), 'x', i.intersect, s),
    y: (t, e, i, s) => Ri(t, Pe(e, t), 'y', i.intersect, s),
  },
};
...
function ji(t, e, i, s) {
  ...
  a.getPadding && Hi(r, a.getPadding());
  const l = Math.max(0, e.outerWidth - Ni(r, t, 'left', 'right')),
    h = Math.max(0, e.outerHeight - Ni(r, t, 'top', 'bottom')),
    c = l !== t.w,
    d = h !== t.h;
  return (
    (t.w = l),
...
function Ui(t, e, i, s) {
  ...
  for (o = 0, a = t.length, h = 0; o < a; ++o) {
    (r = t[o]),
      (l = r.box),
      l.update(r.width || e.w, r.height || e.h, $i(r.horizontal, e));
    const { same: a, other: d } = ji(e, i, r, s);
    (h |= a && n.length), (c = c || d), l.fullSize || n.push(r);
  }
  return (h && Ui(n, e, i, s)) || c;
}
...
var qi = {
  ...
  update(t, e, i, s) {
    if (!t) return;
    const n = qt(t.options.layout.padding),
    ...
    const f = Object.assign(
        { maxPadding: g, w: o, h: a, x: n.left, y: n.top },
        n,
      ),
      p = Wi(l.concat(h), u);
    Ui(r.fullSize, f, u, p),
      Ui(l, f, u, p),
      Ui(h, f, u, p) && Ui(l, f, u, p),
      (function (t) {
      ...
      Xi(r.leftAndTop, f, u, p),
      (f.x += f.w),
      (f.y += f.h),
      Xi(r.rightAndBottom, f, u, p),
      (t.chartArea = {
        left: f.left,
        top: f.top,
        right: f.left + f.w,
...
function ls(t, e, i) {
  ...
  return (
    a.observe(n),
    (function (t, e) {
      os.size || window.addEventListener('resize', rs), os.set(t, e);
    })(t, o),
    a
  );
}
function hs(t, e, i) {
  i && i.disconnect(),
    'resize' === e &&
      (function (t) {
        os.delete(t), os.size || window.removeEventListener('resize', rs);
      })(t);
}
function cs(t, e, i) {
  const s = t.canvas,
...
class ds extends Ki {
  ...
  addEventListener(t, e, i) {
    ...
    const s = t.$proxies || (t.$proxies = {}),
      n = { attach: ss, detach: ns, resize: ls }[e] || cs;
    s[e] = n(t, e, i);
  }
  removeEventListener(t, e) {
    const i = t.$proxies || (t.$proxies = {}),
      s = i[e];
    if (!s) return;
    (({ attach: hs, detach: hs, resize: hs })[e] || es)(t, e, s),
      (i[e] = void 0);
  }
  getDevicePixelRatio() {
...
function fs(t, e) {
  ...
  if (r > 0) {
    ...
    for (ps(e, c, d, s(n) ? 0 : l - n, l), t = 0, i = r - 1; t < i; t++)
      ps(e, c, d, a[t], a[t + 1]);
    return ps(e, c, d, h, s(n) ? e.length : h + n), c;
  }
  return ps(e, c, d), c;
}
...
const ms = (t, e, i) => ('top' === e || 'left' === e ? t[e] + i : t[e] - i),
  xs = (t, e) => Math.min(e || t, t);
function bs(t, e) {
  const i = [],
    s = t.length / e,
    n = t.length;
...
class ws extends gs {
  ...
  calculateLabelRotation() {
    const t = this.options,
      e = t.ticks,
      i = xs(this.ticks.length, t.ticks.maxTicksLimit),
      s = e.minRotation || 0,
      n = e.maxRotation;
    let o,
      a,
    ...
    (o = t.offset ? this.maxWidth / i : u / (i - 1)),
      c + 6 > o &&
        ...
        (l = W(
          Math.min(
            Math.asin(X((h.highest.height + 6) / o, -1, 1)),
            Math.asin(X(a / r, -1, 1)) - Math.asin(X(d / r, -1, 1)),
          ),
        )),
      ...
      if (
        ...
        if (n(f))
          for (u = 0, g = f.length; u < g; ++u)
            (v = f[u]),
              s(v) || n(v) || ((_ = Pt(o, x.data, x.gc, _, v)), (y += b));
      } else (_ = Pt(o, x.data, x.gc, _, f)), (y = b);
  ...
  getPixelForDecimal(t) {
    ...
    return X(this._alignToPixels ? Ct(this.chart, e, 0) : e, -32768, 32767);
  }
    ...
    if (t >= 0 && t < e.length) {
      ...
      return (
        ...
        (i.$context = (function (t, e, i) {
          return Jt(t, { tick: i, index: e, type: 'tick' });
        })(this.getContext(), t, i))
      );
    }
    return (
      this.$context ||
      (this.$context = Jt(this.chart.getContext(), {
        scale: this,
        type: 'scale',
      }))
    );
  ...
  _computeLabelItems(t) {
    ...
    if ('top' === s)
      ...
      if ('center' === s) w = (t.top + t.bottom) / 2 + f;
      else if (o(s)) {
      ...
      if ('center' === s) M = (t.left + t.right) / 2 - f;
      else if (o(s)) {
        const t = Object.keys(s)[0],
          e = s[t];
  ...
  drawBorder() {
    ...
    this.isHorizontal()
      ? ((l = Ct(t, this.left, o) - o / 2),
        (h = Ct(t, this.right, a) + a / 2),
        (c = d = r))
      : ((c = Ct(t, this.top, o) - o / 2),
        (d = Ct(t, this.bottom, a) + a / 2),
        (l = h = r)),
      e.save(),
      (e.lineWidth = n.width),
  ...
  drawLabels(t) {
    ...
    for (const t of s) {
      const i = t.options,
        s = t.font;
      Bt(e, t.label, 0, t.textOffset, s, i);
    }
    i && Rt(e);
  }
  drawTitle() {
    ...
    const {
      ...
      if (t.isHorizontal()) {
        if (((g = nt(s, a, l)), o(i))) {
          ...
          f = 'center' === i ? (c.bottom + c.top) / 2 + m - e : ms(t, i, e);
        u = l - a;
      } else {
        if (o(i)) {
          const t = Object.keys(i)[0],
          ...
          g = 'center' === i ? (c.left + c.right) / 2 - x + e : ms(t, i, e);
        (f = nt(s, r, n)), (p = 'left' === i ? -A : A);
      }
      return { titleX: g, titleY: f, maxWidth: u, rotation: p };
    })(this, h, e, l);
    Bt(t, i.text, 0, 0, a, {
      color: i.color,
      maxWidth: u,
  ...
  _resolveTickFontOptions(t) {
    return Kt(this.options.ticks.setContext(this.getContext(t)).font);
  }
  _maxDigits() {
...
class ks {
    ...
    return (
      n in s ||
        ...
        (function (t, e, i) {
          ...
          t.descriptors && St.describe(e, t.descriptors);
        })(t, o, i),
  ...
  unregister(t) {
    const e = this.items,
      ...
      s = this.scope;
    i in e && delete e[i],
      s && i in St[s] && (delete St[s][i], this.override && delete yt[i]);
  }
}
class Ss {
  constructor() {
    (this.controllers = new ks(li, 'datasets', !0)),
      (this.elements = new ks(gs, 'elements')),
  ...
  _createDescriptors(t, e) {
    const i = t && t.config,
      ...
      n = (function (t) {
        const e = {},
          i = [],
          s = Object.keys(Ps.plugins.items);
        for (let t = 0; t < s.length; t++) i.push(Ps.getPlugin(s[t]));
        const n = t.plugins || [];
        for (let t = 0; t < n.length; t++) {
          const s = n[t];
      ...
      ? (function (t, { plugins: e, localIds: i }, s, n) {
          ...
          for (const r of e) {
            ...
            null !== l &&
              o.push({
                plugin: r,
                options: Os(t.config, { plugin: r, local: i[e] }, l, a),
              });
          }
          return o;
        })(t, n, s, e)
...
function Os(t, { plugin: e, local: i }, s, n) {
...
function Is(t) {
  ...
  (e.plugins = l(e.plugins, {})), (e.scales = Rs(t, e));
}
function zs(t) {
  return (
...
function Bs(t, e) {
  let i = Fs.get(t);
  return i || ((i = e()), Fs.set(t, i), Vs.add(i)), i;
}
const Ws = (t, e, i) => {
  const s = y(e, i);
  void 0 !== s && t.add(s);
...
class Ns {
  constructor(t) {
    (this._config = (function (t) {
      return ((t = t || {}).data = zs(t.data)), Is(t), t;
    })(t)),
  ...
  datasetScopeKeys(t) {
    return Bs(t, () => [[`datasets.${t}`, '']]);
  }
  datasetAnimationScopeKeys(t, e) {
    return Bs(`${t}.transition.${e}`, () => [
  ...
  getOptionScopes(t, e, i) {
    ...
    const r = new Set();
    e.forEach((e) => {
      t && (r.add(t), e.forEach((e) => Ws(r, t, e))),
        e.forEach((t) => Ws(r, s, t)),
        e.forEach((t) => Ws(r, yt[n] || {}, t)),
        e.forEach((t) => Ws(r, St, t)),
        e.forEach((t) => Ws(r, vt, t));
    });
    const l = Array.from(r);
    return (
      0 === l.length && l.push(Object.create(null)), Vs.has(e) && o.set(e, l), l
    );
  }
  chartOptionScopes() {
    const { options: t, type: e } = this;
    return [t, yt[e] || {}, St.datasets[e] || {}, { type: e }, St, vt];
  }
  resolveNamedOptions(t, e, i, s = ['']) {
    const o = { $shared: !0 },
      { resolver: a, subPrefixes: r } = Hs(this._resolverCache, t, s);
    let l = a;
    if (
      (function (t, e) {
        ...
        for (const o of e) {
          const e = i(o),
            a = s(o),
            r = (a || e) && t[o];
          if ((e && (w(r) || js(r))) || (a && n(r))) return !0;
        }
        return !1;
      })(a, e)
    ) {
      o.$shared = !1;
      l = Zt(a, (i = w(i) ? i() : i), this.createResolver(t, i, r));
    }
    for (const t of e) o[t] = l[t];
    return o;
  }
  createResolver(t, e, i = [''], s) {
    const { resolver: n } = Hs(this._resolverCache, t, i);
    return o(e) ? Zt(n, e, void 0, s) : n;
  }
}
function Hs(t, e, i) {
  let s = t.get(e);
...
const js = (t) => o(t) && Object.getOwnPropertyNames(t).some((e) => w(t[e]));
const $s = ['top', 'bottom', 'left', 'right', 'chartArea'];
function Us(t, e) {
...
class tn {
  ...
  constructor(t, e) {
    ...
    (this.platform = new (s.platform || us(n))()),
    ...
    (this.id = i()),
      ...
      (Gs[this.id] = this),
      r && l
        ? (Ye.listen(this, 'complete', Xs),
          Ye.listen(this, 'progress', qs),
          this._initialize(),
  ...
  _initialize() {
    return (
      ...
      this.options.responsive
        ? this.resize()
        : Oe(this, this.options.devicePixelRatio),
      this.bindEvents(),
  ...
  clear() {
    return Ot(this.canvas, this.ctx), this;
  }
  stop() {
    ...
    e &&
      ...
      d(n, (e) => {
        const n = e.options,
          ...
          a = Ls(o, n),
          r = l(n.type, e.dtype);
        (void 0 !== n.position && Us(n.position, a) === Us(e.dposition)) ||
  ...
  buildOrUpdateControllers() {
    ...
    for (this._removeUnreferencedMetasets(), i = 0, s = e.length; i < s; i++) {
      ...
      if (
        ...
        (n.type = o),
        (n.indexAxis = s.indexAxis || As(o, this.options)),
        (n.order = s.order || 0),
        (n.index = i),
        (n.label = `${s.label}`),
        ...
        const e = Ps.getController(o),
          { datasetElementType: s, dataElementType: a } = St.datasets[o];
        Object.assign(e, {
          dataElementType: Ps.getElement(a),
          datasetElementType: s && Ps.getElement(s),
        }),
  ...
  _checkEventBindings() {
    const t = this.options,
      ...
      i = new Set(t.events);
    (k(e, i) && !!this._responsiveListeners === t.responsive) ||
  ...
  _updateDatasets(t) {
    if (
      ...
      for (let e = 0, i = this.data.datasets.length; e < i; ++e)
        this._updateDataset(e, w(t) ? t({ datasetIndex: e }) : t);
  ...
  render() {
    !1 !== this.notifyPlugins('beforeRender', { cancelable: !0 }) &&
      (Ye.has(this)
        ? this.attached && !Ye.running(this) && Ye.start(this)
  ...
  getContext() {
    return (
      this.$context ||
      (this.$context = Jt(null, { chart: this, type: 'chart' }))
    );
  }
  ...
  _stop() {
    let t, e;
    for (
      this.stop(), Ye.remove(this), t = 0, e = this.data.datasets.length;
      t < e;
      ++t
    )
...
function en() {
  return d(tn.instances, (t) => t._plugins.invalidate());
}
function sn(t, e, i, s) {
  const n = Ut(t.options.borderRadius, [
    'outerStart',
    'outerEnd',
    'innerStart',
    'innerEnd',
...
function on(t, e, i, s, n, o) {
  ...
  const p = (f - Math.max(0.001, f * d - i / S) / d) / 2,
    m = l + p + g,
    x = n - p - g,
    {
      outerStart: b,
  ...
  if ((t.beginPath(), o)) {
    const e = (k + P) / 2;
    if ((t.arc(a, r, d, k, e), t.arc(a, r, d, e, P), _ > 0)) {
      const e = nn(w, P, a, r);
      t.arc(e.x, e.y, _, P, x + A);
    }
    const i = nn(C, x, a, r);
    if ((t.lineTo(i.x, i.y), v > 0)) {
      const e = nn(C, T, a, r);
      t.arc(e.x, e.y, v, x + A, T + Math.PI);
    }
    ...
    if (
      ...
      const e = nn(D, O, a, r);
      t.arc(e.x, e.y, y, O + Math.PI, m - A);
    }
    const n = nn(M, m, a, r);
    if ((t.lineTo(n.x, n.y), b > 0)) {
      const e = nn(M, k, a, r);
      t.arc(e.x, e.y, b, m - A, k);
    }
  } else {
    t.moveTo(a, r);
...
class rn extends gs {
  ...
  inRange(t, e, i) {
    const s = this.getProps(['x', 'y'], i),
      { angle: n, distance: o } = H(s, { x: t, y: e }),
      {
        startAngle: a,
        endAngle: r,
        innerRadius: h,
  ...
  draw(t) {
    ...
    if (
      ...
      (this.fullCircles = i > P ? Math.floor(i / P) : 0),
    ...
    const r = s * (1 - Math.sin(Math.min(S, i || 0)));
...
function dn(t, e, i, s) {
  const { points: n, options: o } = e,
    { count: a, start: r, loop: l, ilen: h } = cn(n, i, s),
    c = (function (t) {
      return t.stepped
        ? It
  ...
  for (d = 0; d <= h; ++d)
    (u = n[(r + (p ? h - d : d)) % a]),
      u.skip ||
        (f ? (t.moveTo(u.x, u.y), (f = !1)) : c(t, g, u, p, o.stepped),
        (g = u));
  return l && ((u = n[(r + (p ? h : 0)) % a]), c(t, g, u, p, o.stepped)), !!l;
}
function un(t, e, i, s) {
  const n = e.points,
    { count: o, start: a, ilen: r } = cn(n, i, s),
...
class mn extends gs {
  ...
  updateControlPoints(t, e) {
    ...
    if (
      ...
      be(this._points, i, t, s, e), (this._pointsUpdated = !0);
    }
  }
  set points(t) {
    (this._points = t),
  ...
  interpolate(t, e) {
    const i = this.options,
      s = t[e],
      n = this.points,
      o = Ne(this, { property: e, start: s, end: s });
    if (!o.length) return;
    const a = [],
      r = (function (t) {
        return t.stepped
  ...
  draw(t, e, i, s) {
    ...
    (this.points || []).length &&
      n.borderWidth &&
      (t.save(), pn(t, this, i, s), t.restore()),
  ...
  const e = _n(t),
    ...
    a = (function (t, e, i) {
      const { enableBorderRadius: s } = t.getProps(['enableBorderRadius']),
        ...
        h = s || o(n);
      return {
        topLeft: yn(!h || l.top || l.left, a.topLeft, 0, r),
        topRight: yn(!h || l.top || l.right, a.topRight, 0, r),
        bottomLeft: yn(!h || l.bottom || l.left, a.bottomLeft, 0, r),
        bottomRight: yn(!h || l.bottom || l.right, a.bottomRight, 0, r),
      };
    })(t, i / 2, s / 2);
  return {
...
class Sn extends gs {
  ...
  inRange(t, e, i) {
    return Mn(this, t, e, i);
  }
  inXRange(t, e) {
    return Mn(this, t, null, e);
  }
  inYRange(t, e) {
    return Mn(this, null, t, e);
  }
  getCenterPoint(t) {
    const {
      x: e,
...
const Dn = [
  ...
  Cn = Dn.map((t) => t.replace('rgb(', 'rgba(').replace(')', ', 0.5)'));
function On(t) {
  return Dn[t % Dn.length];
}
function An(t) {
  return Cn[t % Cn.length];
}
function Tn(t) {
  let e = 0;
  return (i, s) => {
    ...
    n instanceof _i
      ? (e = (function (t, e) {
          return (t.backgroundColor = t.data.map(() => On(e++))), e;
        })(i, e))
      : n instanceof vi
        ? (e = (function (t, e) {
            return (t.backgroundColor = t.data.map(() => An(e++))), e;
          })(i, e))
        : n &&
          (e = (function (t, e) {
            return (t.borderColor = On(e)), (t.backgroundColor = An(e)), ++e;
          })(i, e));
  };
}
function Ln(t) {
...
var zn = {
  ...
  beforeElementsUpdate: (t, e, i) => {
    if (!i.enabled) return void In(t);
    const n = t.width;
    t.data.datasets.forEach((e, o) => {
      const { _data: a, indexAxis: r } = e,
        l = t.getDatasetMeta(o),
        h = a || e.data;
      if ('y' === Gt([r, t.options.indexAxis])) return;
      ...
      let { start: d, count: u } = (function (t, e) {
        ...
        return (
          l && (n = X(G(e, o.axis, a).lo, 0, i - 1)),
          (s = h ? X(G(e, o.axis, r).hi + 1, n, i) - n : i - n),
          { start: n, count: s }
        );
      })(l, h);
      if (u <= (i.threshold || 4 * n)) return void Rn(e);
      let g;
      switch (
        (s(a) &&
          ((e._data = h),
...
function Fn(t, e, i, s) {
  ...
  let n = e[t],
    o = i[t];
  return (
    'angle' === t && ((n = U(n)), (o = U(o))), { property: t, start: n, end: o }
  );
}
function Vn(t, e, i) {
  for (; e > t; e--) {
...
function Wn(t, e) {
  ...
  return (
    ...
    i.length
      ? new mn({ points: i, options: { tension: 0 }, _loop: s, _fullLoop: s })
      : null
  );
}
function Nn(t) {
...
function $n(t, e, i) {
  ...
  for (let n = 0; n < i.length; n++) {
    const o = i[n],
      { first: a, last: r, point: l } = Un(o, e, 'x');
    if (!(!l || (a && r)))
      if (a) s.unshift(l);
...
function Xn(t) {
  ...
  if ('stack' === i)
    return (function (t) {
      ...
      r.push(Wn({ x: null, y: e.bottom }, s));
      for (let t = 0; t < o.length; t++) {
        const e = o[t];
        for (let t = e.start; t <= e.end; t++) $n(n, a[t], r);
      }
      return new mn({ points: n, options: {} });
    })(t);
  if ('shape' === i) return !0;
  const n = (function (t) {
    const e = t.scale || {};
  ...
  return n instanceof Yn ? n : Wn(n, s);
}
function qn(t, e, i) {
  const s = Xn(e),
    ...
    (function (t, e) {
      ...
      t.save(),
        'x' === l &&
          o !== n &&
          (Kn(t, s, a.top),
          Gn(t, { line: i, target: s, color: n, scale: r, property: l }),
          t.restore(),
          t.save(),
          Kn(t, s, a.bottom));
      Gn(t, { line: i, target: s, color: o, scale: r, property: l }),
        t.restore();
    })(t, {
      line: n,
      target: s,
...
function Gn(t, e) {
  const { line: i, target: s, property: n, color: o, scale: a } = e,
    r = (function (t, e, i) {
      ...
      for (const t of s) {
        ...
        const h = Ne(e, l);
        for (const e of h) {
          const s = Fn(i, o[e.start], o[e.end], e.loop),
            r = We(t, n, s);
          for (const t of r)
            a.push({
              source: t,
              target: e,
              start: { [i]: Bn(l, s, 'start', Math.max) },
              end: { [i]: Bn(l, s, 'end', Math.min) },
            });
        }
      }
      return a;
  ...
  for (const { source: e, target: l, start: h, end: c } of r) {
    const { style: { backgroundColor: r = o } = {} } = e,
      d = !0 !== s;
    t.save(), (t.fillStyle = r), Jn(t, a, d && Fn(n, h, c)), t.beginPath();
    const u = !!i.pathSegment(t, e);
    let g;
    if (d) {
      u ? t.closePath() : Qn(t, s, c, n);
...
var Zn = {
  ...
  afterDatasetsUpdate(t, e, i) {
    ...
    for (a = 0; a < s; ++a)
      (o = t.getDatasetMeta(a)),
        ...
        n.push(l);
    for (a = 0; a < s; ++a)
      (l = n[a]), l && !1 !== l.fill && (l.fill = Hn(n, a, i.propagate));
  },
  beforeDraw(t, e, i) {
    ...
    for (let e = n.length - 1; e >= 0; --e) {
      const i = n[e].$filler;
      i &&
        (i.line.updateControlPoints(o, i.axis), s && i.fill && qn(t.ctx, i, o));
    }
  },
  beforeDatasetsDraw(t, e, i) {
    ...
    for (let e = s.length - 1; e >= 0; --e) {
      const i = s[e].$filler;
      Nn(i) && qn(t.ctx, i, t.chartArea);
    }
  },
  beforeDatasetDraw(t, e, i) {
    const s = e.meta.$filler;
    Nn(s) && 'beforeDatasetDraw' === i.drawTime && qn(t.ctx, s, t.chartArea);
  },
...
class eo extends gs {
  ...
  _fitRows(t, e, i, s) {
    ...
    return (
      this.legendItems.forEach((t, g) => {
        ...
        (0 === g || l[l.length - 1] + f + 2 * a > o) &&
          ((c += h), (l[l.length - (g > 0 ? 0 : 1)] = 0), (u += h), d++),
          (r[g] = { left: 0, top: u, row: d, width: f, height: s }),
          (l[l.length - 1] += f + a);
      }),
      c
    );
    ...
    return (
      this.legendItems.forEach((t, o) => {
        ...
        o > 0 &&
          ...
          f++,
          (d = u = 0)),
          (r[o] = { left: g, top: u, col: f, width: p, height: m }),
          (d = Math.max(d, p)),
          (u += m + a);
      }),
      (c += d),
  ...
  _draw() {
    const { options: t, columnSizes: e, lineWidths: i, ctx: s } = this,
      { align: n, labels: o } = t,
      a = St.color,
      r = Ie(t.rtl, this.left, this.width),
      h = Kt(o.font),
      { padding: c } = o,
      d = h.size,
      u = d / 2;
    ...
    this.drawTitle(),
      ...
      (s.lineWidth = 0.5),
      (s.font = h.string);
    const { boxWidth: f, boxHeight: p, itemHeight: m } = to(o, d),
      x = this.isHorizontal(),
      b = this._computeTitleHeight();
    (g = x
      ? {
          x: nt(n, this.left + c, this.right - i[0]),
          y: this.top + c + b,
          line: 0,
        }
      : {
          x: this.left + c,
          y: nt(n, this.top + b + c, this.bottom - e[0].height),
          line: 0,
        }),
      ze(this.ctx, t.textDirection);
    const _ = m + c;
      ...
      r.setWidth(this.width),
        x
          ? v > 0 &&
            ...
            ((P = g.y += _),
            g.line++,
            (S = g.x = nt(n, this.left + c, this.right - i[g.line])))
          : v > 0 &&
            P + _ > this.bottom &&
            ((S = g.x = S + e[g.line].width + c),
            g.line++,
            (P = g.y =
              nt(n, this.top + b + c, this.bottom - e[g.line].height)));
      if (
        ((function (t, e, i) {
          ...
          if (
            ...
            const a = {
              ...
              l = r.xPlus(t, f / 2);
            Tt(s, a, l, e + u, o.pointStyleWidth && f);
          } else {
  ...
  drawTitle() {
    const t = this.options,
      ...
      s = qt(e.padding);
    if (!e.display) return;
    const n = Ie(t.rtl, this.left, this.width),
      o = this.ctx,
      a = e.position,
      r = i.size / 2,
      l = s.top + r;
...
class no extends gs {
  ...
  update(t, e) {
    ...
    this._padding = qt(i.padding);
    const o = s * Kt(i.font).lineHeight + this._padding.height;
  ...
  _drawArgs(t) {
    ...
    return (
      this.isHorizontal()
        ...
        : ('left' === o.position
            ? ((l = i + t), (h = nt(a, s, e)), (c = -0.5 * S))
            : ((l = n - t), (h = nt(a, e, s)), (c = 0.5 * S)),
          (r = s - e)),
...
var oo = {
  ...
  start(t, e, i) {
    !(function (t, e) {
      const i = new no({ ctx: t.ctx, options: e, chart: t });
...
var ro = {
  id: 'subtitle',
  start(t, e, i) {
    const s = new no({ ctx: t.ctx, options: i, chart: t });
    qi.configure(t, s, i), qi.addBox(t, s), ao.set(t, s);
  },
  stop(t) {
    qi.removeBox(t, ao.get(t)), ao.delete(t);
  },
  beforeUpdate(t, e, i) {
    const s = ao.get(t);
    qi.configure(t, s, i), (s.options = i);
...
function go(t, e) {
  ...
  if (
    ...
    u &&
      (m += u * h.lineHeight + (u - 1) * e.titleSpacing + e.titleMarginBottom),
    b)
  ) {
    m +=
...
function mo(t, e, i, s) {
  const { caretSize: n, caretPadding: o, cornerRadius: a } = t,
    { xAlign: r, yAlign: l } = i,
    h = n + o,
    { topLeft: c, topRight: d, bottomLeft: u, bottomRight: g } = Xt(a);
  let f = (function (t, e) {
    let { x: i, width: s } = t;
  ...
  return (
    'center' === l
      ...
      : 'left' === r
        ? (f -= Math.max(c, u) + n)
        : 'right' === r && (f += Math.max(d, g) + n),
    { x: X(f, 0, s.width - e.width), y: X(p, 0, s.height - e.height) }
  );
}
function xo(t, e, i) {
  const s = qt(i.padding);
  return 'center' === e
    ? t.x + t.width / 2
    : 'right' === e
      ? t.x + t.width - s.right
...
function vo(t, e, i, s) {
  ...
  return void 0 === n ? yo[e].call(i, s) : n;
}
class Mo extends gs {
  ...
  getContext() {
    return (
      ...
      (this.$context =
        ...
        Jt(t, { tooltip: e, tooltipItems: i, type: 'tooltip' })))
    );
    var t, e, i;
  }
  getTitle(t, e) {
    const { callbacks: i } = e,
      s = vo(i, 'beforeTitle', this, t),
      n = vo(i, 'title', this, t),
      o = vo(i, 'afterTitle', this, t);
    let a = [];
    return (a = ho(a, co(s))), (a = ho(a, co(n))), (a = ho(a, co(o))), a;
  }
  getBeforeBody(t, e) {
    return bo(vo(e.callbacks, 'beforeBody', this, t));
  }
  getBody(t, e) {
    const { callbacks: i } = e,
      s = [];
    return (
      d(t, (t) => {
        const e = { before: [], lines: [], after: [] },
          n = _o(i, t);
        ho(e.before, co(vo(n, 'beforeLabel', this, t))),
          ho(e.lines, vo(n, 'label', this, t)),
          ho(e.after, co(vo(n, 'afterLabel', this, t))),
          s.push(e);
      }),
      s
    );
  ...
  getAfterBody(t, e) {
    return bo(vo(e.callbacks, 'afterBody', this, t));
  }
  getFooter(t, e) {
    const { callbacks: i } = e,
      s = vo(i, 'beforeFooter', this, t),
      n = vo(i, 'footer', this, t),
  ...
  _createItems(t) {
    ...
    return (
      ...
      d(l, (e) => {
        const i = _o(t.callbacks, e);
        s.push(vo(i, 'labelColor', this, e)),
          n.push(vo(i, 'labelPointStyle', this, e)),
  ...
  update(t, e) {
    ...
    let n,
      o = [];
    if (s.length) {
      const t = lo[i.position].call(this, s, this._eventPosition);
      ...
      const e = (this._size = go(this, i)),
        a = Object.assign({}, t, e),
        r = po(this.chart, i, a),
        l = mo(i, a, r, this.chart);
  ...
  getCaretPosition(t, e, i) {
    const { xAlign: s, yAlign: n } = this,
      ...
      { topLeft: r, topRight: l, bottomLeft: h, bottomRight: c } = Xt(a),
      { x: d, y: u } = t,
      { width: g, height: f } = e;
    let p, m, x, b, _, y;
    return (
  ...
  drawTitle(t, e, i) {
    ...
    let o, a, r;
    if (n) {
      const l = Ie(i.rtl, this.x, this.width);
      for (
  ...
  _drawColorBox(t, e, i, s, n) {
    ...
    if (n.usePointStyle) {
      ...
      Object.values(r).some((t) => 0 !== t)
        ? (t.beginPath(),
          (t.fillStyle = n.multiKeyBackground),
          Wt(t, { x: e, y: f, w: h, h: l, radius: r }),
          t.fill(),
          t.stroke(),
          (t.fillStyle = a.backgroundColor),
          t.beginPath(),
          Wt(t, { x: i, y: f + 1, w: h - 2, h: l - 2, radius: r }),
          t.fill())
        : ((t.fillStyle = n.multiKeyBackground),
          t.fillRect(e, f, h, l),
          t.strokeRect(e, f, h, l),
          (t.fillStyle = a.backgroundColor),
          t.fillRect(i, f + 1, h - 2, l - 2));
    }
  ...
  drawBody(t, e, i) {
    ...
    let u = c.lineHeight,
      g = 0;
    const f = Ie(i.rtl, this.x, this.width),
      p = function (i) {
        e.fillText(i, f.x(t.x + g), t.y + u / 2), (t.y += u + n);
      },
      m = f.textAlign(o);
    let x, b, _, y, v, M, w;
    for (
      e.textAlign = o,
        ...
        d(this.beforeBody, p),
        g = a && 'right' !== m ? ('center' === o ? l / 2 + h : l + 2 + h) : 0,
        y = 0,
        M = s.length;
      y < M;
      ++y
    ...
    (g = 0), (u = c.lineHeight), d(this.afterBody, p), (t.y -= n);
  }
  drawFooter(t, e, i) {
    const s = this.footer,
      n = s.length;
    let o, a;
    if (n) {
      const r = Ie(i.rtl, this.x, this.width);
      for (
  ...
  drawBackground(t, e, i, s) {
    ...
    (e.fillStyle = s.backgroundColor),
      ...
      e.lineTo(a + l, r + h - g),
      e.quadraticCurveTo(a + l, r + h, a + l - g, r + h),
  ...
  draw(t) {
    ...
    e.enabled &&
      ...
      ze(t, e.textDirection),
      (n.y += o.top),
      this.drawTitle(n, t, e),
      this.drawBody(n, t, e),
      this.drawFooter(n, t, e),
      Fe(t, e.textDirection),
      t.restore());
  }
  getActiveElements() {
    return this._active || [];
...
var wo = {
    ...
    positioners: lo,
    afterInit(t, e, i) {
      i && (t.tooltip = new Mo({ chart: t, options: i }));
    },
    beforeUpdate(t, e, i) {
...
class Do extends ws {
  ...
  parse(t, e) {
    ...
    return ((t, e) => (null === t ? null : X(Math.round(t), 0, e)))(
      (e =
        isFinite(e) && i[e] === t ? e : So(i, t, l(e, t), this._addedLabels)),
      i.length - 1,
    );
  }
  determineDataLimits() {
...
function Co(t, e) {
  ...
  (k = Math.ceil(m / S) - Math.floor(p / S)),
    ...
    (function (t, e) {
      ...
      : _
        ...
        : ((k = (w - M) / S),
          (k = I(k, Math.round(k), S / 1e3) ? Math.round(k) : Math.ceil(k)));
  const P = Math.max(N(S), N(M));
  ...
  for (
    ...
    (u && M !== a
      ? (i.push({ value: a }),
        M < a && D++,
        I(Math.round((M + D * S) * v) / v, a, Oo(a, y, t)) && D++)
      : M < a && D++);
    D < k;
    ++D
  ) {
  ...
  return (
    b && u && w !== r
      ? i.length && I(i[i.length - 1].value, r, Oo(r, y, t))
...
function Oo(t, e, { horizontal: i, minRotation: s }) {
  const n = B(s),
...
class To extends Ao {
  static id = 'linear';
  static defaults = { ticks: { callback: _t.formatters.numeric } };
  determineDataLimits() {
...
const Lo = (t) => Math.floor(E(t)),
  Eo = (t, e) => Math.pow(10, Lo(t) + e);
function Ro(t) {
  return 1 === t / Math.pow(10, Lo(t));
}
function Io(t, e, i) {
...
function zo(t, { min: e, max: i }) {
  ...
  let u = Math.floor((c - d) / Math.pow(10, o)),
    g = r(t.min, Math.round((h + d + u * Math.pow(10, o)) * a) / a);
  for (; g < i; )
    s.push({ value: g, major: Ro(g), significand: u }),
      u >= 10 ? (u = u < 15 ? 15 : 20) : u++,
      u >= 20 && (o++, (u = 2), (a = o >= 0 ? 1 : a)),
      (g = Math.round((h + d + u * Math.pow(10, o)) * a) / a);
  const f = r(t.max, g);
  return s.push({ value: f, major: Ro(f), significand: u }), s;
}
class Fo extends ws {
  static id = 'logarithmic';
  static defaults = {
    ticks: { callback: _t.formatters.logarithmic, major: { enabled: !0 } },
  };
  constructor(t) {
    super(t),
      (this.start = void 0),
  ...
  parse(t, e) {
    const i = Ao.prototype.parse.apply(this, [t, e]);
  ...
  determineDataLimits() {
    ...
    (this.min = a(t) ? Math.max(0, t) : null),
      ...
      this._zero &&
        ...
        !a(this._userMin) &&
        (this.min = t === Eo(this.min, 0) ? Eo(this.min, -1) : Eo(this.min, 0)),
      this.handleTickRangeOptions();
  }
  handleTickRangeOptions() {
    const { minDefined: t, maxDefined: e } = this.getUserBounds();
    ...
    const n = (e) => (i = t ? i : e),
      o = (t) => (s = e ? s : t);
    i === s && (i <= 0 ? (n(1), o(10)) : (n(Eo(i, -1)), o(Eo(s, 1)))),
      i <= 0 && n(Eo(s, -1)),
      s <= 0 && o(Eo(i, 1)),
      (this.min = i),
      (this.max = s);
  ...
  buildTicks() {
    const t = this.options,
      e = zo({ min: this._userMin, max: this._userMax }, this);
    return (
...
function Vo(t) {
  ...
  if (e.display && t.display) {
    const t = qt(e.backdropPadding);
    return l(e.font && e.font.size, St.font.size) + t.height;
  }
  return 0;
}
function Bo(t, e, i, s, n) {
  return t === s || t === n
...
function Wo(t) {
  const e = {
    ...
    l = r.centerPointLabels ? S / a : 0;
  for (let u = 0; u < a; u++) {
    const a = r.setContext(t.getPointLabelContext(u));
    o[u] = a.padding;
    const g = t.getPointPosition(u, t.drawingArea + o[u], l),
      f = Kt(a.font),
      p =
        ((h = t.ctx),
        (c = f),
        (d = n((d = t._pointLabels[u])) ? d : [d]),
        { w: Dt(h, c.string, d), h: d.length * c.lineHeight });
    s[u] = p;
    const m = U(t.getIndexAngle(u) + l),
      x = Math.round(W(m));
    No(i, e, m, Bo(x, g.x, p.w, 0, 180), Bo(x, g.y, p.h, 90, 270));
  }
  var h, c, d;
  t.setCenterPoint(e.l - i.l, i.r - e.r, e.t - i.t, i.b - e.b),
    (t._pointLabelItems = (function (t, e, i) {
      const s = [],
        ...
        l = { extra: Vo(o) / 2, additionalAngle: a ? S / n : 0 };
      let h;
      for (let o = 0; o < n; o++) {
        (l.padding = i[o]), (l.size = e[o]);
        const n = Ho(t, o, l);
        s.push(n),
          'auto' === r && ((n.visible = jo(n, h)), n.visible && (h = n));
      }
      return s;
    })(t, s, o));
}
...
function $o(t, e, i) {
  const { left: n, top: o, right: a, bottom: r } = i,
    { backdropColor: l } = e;
  if (!s(l)) {
    const i = Xt(e.borderRadius),
      s = qt(e.backdropPadding);
    t.fillStyle = l;
    const h = n - s.left,
      c = o - s.top,
      d = a - n + s.width,
    ...
    Object.values(i).some((t) => 0 !== t)
      ? (t.beginPath(), Wt(t, { x: h, y: c, w: d, h: u, radius: i }), t.fill())
      : t.fillRect(h, c, d, u);
  }
}
function Uo(t, e, i, s) {
  const { ctx: n } = t;
  if (i) n.arc(t.xCenter, t.yCenter, e, 0, P);
  else {
...
class Yo extends Ao {
  ...
  static defaults = {
    ...
    grid: { circular: !1 },
    startAngle: 0,
    ticks: { showLabelBackdrop: !0, callback: _t.formatters.numeric },
    pointLabels: {
  ...
  setDimensions() {
    const t = (this._padding = qt(Vo(this.options) / 2)),
  ...
  getIndexAngle(t) {
    return U(
      t * (P / (this._pointLabels.length || 1)) +
        B(this.options.startAngle || 0),
    );
  }
  ...
  getPointLabelContext(t) {
    ...
    if (t >= 0 && t < e.length) {
      ...
      return (function (t, e, i) {
        return Jt(t, { label: i, index: e, type: 'pointLabel' });
      })(this.getContext(), t, i);
    }
  }
  getPointPosition(t, e, i = 0) {
    const s = this.getIndexAngle(t) - A + i;
    return {
      ...
      (e.pointLabels.display &&
        (function (t, e) {
          ...
          for (let n = e - 1; n >= 0; n--) {
            ...
            Bt(i, t._pointLabels[n], r, l + a.lineHeight / 2, a, {
              color: o.color,
              textAlign: h,
              textBaseline: 'middle',
            });
...
function Jo(t, e, i, s) {
  const n = qo.length;
  for (let o = qo.indexOf(t); o < n - 1; ++o) {
    const t = Xo[qo[o]],
      n = t.steps ? t.steps : Number.MAX_SAFE_INTEGER;
    if (t.common && Math.ceil((i - e) / (n * t.size)) <= s) return qo[o];
  }
  return qo[n - 1];
}
function Qo(t, e, i) {
...
class ta extends ws {
  ...
  init(t, e = {}) {
    const i = t.time || (t.time = {}),
      s = (this._adapter = new Ci._date(t.adapters.date));
    s.init(e),
  ...
  parse(t, e) {
    return void 0 === t ? null : Go(this, t);
  }
  beforeLayout() {
    ...
    return (
      (this._unit =
        ...
        (i.autoSkip
          ...
          : (function (t, e, i, s, n) {
              for (let o = qo.length - 1; o >= qo.indexOf(i); o--) {
                const i = qo[o];
                if (Xo[i].common && t._adapter.diff(n, s, i) >= e - 1) return i;
              }
              return qo[i ? qo.indexOf(i) : 0];
            })(this, o.length, e.minUnit, this.min, this.max))),
      (this._majorUnit =
        i.major.enabled && 'year' !== this._unit
          ? (function (t) {
              for (let e = qo.indexOf(t) + 1, i = qo.length; e < i; ++e)
                if (Xo[qo[e]].common) return qo[e];
            })(this._unit)
          : void 0),
      this.initOffsets(s),
      t.reverse && o.reverse(),
      Zo(this, o, this._majorUnit)
    );
  }
  afterAutoSkip() {
  ...
  _generate() {
    ...
    let d,
      ...
      g = e;
    if (
      (h && (g = +t.startOf(g, 'isoWeek', r)),
      (g = +t.startOf(g, h ? 'day' : o)),
      t.diff(i, e, o) > 1e5 * a)
    )
      throw new Error(
    ...
    for (d = g, u = 0; d < i; d = +t.add(d, a, o), u++) Qo(c, d, f);
    return (
      (d !== i && 'ticks' !== s.bounds && 1 !== u) || Qo(c, d, f),
      Object.keys(c)
        .sort(Ko)
        .map((t) => +t)
    );
  ...
  _tickFormatFunction(t, e, i, s) {
    ...
    const a = n.time.displayFormats,
      ...
      u = i[e],
      g = l && d && u && u.major;
    return this._adapter.format(t, s || (g ? d : h));
  }
  generateTickLabels(t) {
    let e, i, s;
    for (e = 0, i = t.length; e < i; ++e)
  ...
  _getLabelSize(t) {
    const e = this.options.ticks,
      ...
      s = B(this.isHorizontal() ? e.maxRotation : e.minRotation),
      n = Math.cos(s),
      o = Math.sin(s),
  ...
  _getLabelCapacity(t) {
    const e = this.options.time,
      ...
      n = this._tickFormatFunction(t, 0, Zo(this, [t], this._majorUnit), s),
  ...
  getLabelTimestamps() {
    ...
    for (e = 0, i = s.length; e < i; ++e) t.push(Go(this, s[e]));
...
function ea(t, e, i) {
  let s,
    ...
    l = t.length - 1;
  i
    ? (e >= t[r].pos && e <= t[l].pos && ({ lo: r, hi: l } = G(t, 'pos', e)),
      ({ pos: s, time: o } = t[r]),
      ({ pos: n, time: a } = t[l]))
    : (e >= t[r].time && e <= t[l].time && ({ lo: r, hi: l } = G(t, 'time', e)),
      ({ time: s, pos: o } = t[r]),
      ({ time: n, pos: a } = t[l]));
  const h = n - s;
...
export {
  ...
  Ki as BasePlatform,
  Gi as BasicPlatform,
  bi as BubbleController,
  Do as CategoryScale,
  tn as Chart,
  En as Colors,
  li as DatasetController,
  zn as Decimation,
  ds as DomPlatform,
  _i as DoughnutController,
  gs as Element,
  Zn as Filler,
  Ii as Interaction,
  so as Legend,
  yi as LineController,
  mn as LineElement,
  To as LinearScale,
  Fo as LogarithmicScale,
  Mi as PieController,
  bn as PointElement,
  vi as PolarAreaController,
  wi as RadarController,
  Yo as RadialLinearScale,
  ws as Scale,
  ki as ScatterController,
  ro as SubTitle,
  _t as Ticks,
  ta as TimeScale,
  ia as TimeSeriesScale,
  oo as Title,
  wo as Tooltip,
  Ci as _adapters,
  us as _detectPlatform,
  Ye as animator,
  Si as controllers,
  St as defaults,
  Pn as elements,
...
export default null;
//# sourceMappingURL=/sm/e7c99c8194e7d6fe4320bc233c60c081f2bcb7c49d9fec3fdb84c70d2bfbc75d.map
