...
<div class="sm:flex sm:items-center sm:justify-between">
  ...
  <div class="flex items-center mt-4 gap-x-3">
    <button @click="create" class="flex items-center justify-center gap-x-2 tracking-wide w-1/2 px-5 py-2 text-sm text-gray-800 transition-colors duration-200 bg-white border rounded-lg sm:w-auto dark:hover:bg-gray-800 dark:bg-gray-900 hover:bg-gray-100 dark:text-white dark:border-gray-700">
    ...
    <button @click="publish" class="flex items-center justify-center w-1/2 px-5 py-2 text-sm gap-x-2 tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-lg sm:w-auto hover:bg-blue-600 dark:hover:bg-blue-500 dark:bg-blue-600">
