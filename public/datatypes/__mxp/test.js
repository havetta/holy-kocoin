import { ref } from "vue";
import * as chartJs from "../../npm/chart.js"; // 'https://cdn.jsdelivr.net/npm/chart.js@4.4.1/+esm'
...
export default {
  ...
  mounted() {
    ...
    const secondcharData = {
      ...
      const myChart = new chartJs.Chart(ctx, charData);
      const secondChart = new chartJs.Chart(second, secondcharData);
