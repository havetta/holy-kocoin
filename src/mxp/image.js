...
nodeHtmlToImage({
  ...
  type: 'jpeg',
  html: `<html><head><meta name="viewport" content="width=1024px, initial-scale=1.0" /></head><body><iframe src="http://localhost:5500/src/mxp/test.html" width=1024 height=768 /></body></html>`
